...
## 🚀 Projects
- **BotLabX** — Team project, Node.js/TypeScript/PostgreSQL/AWS, deployed on AWS · [Live Demo](http://54.91.151.79.nip.io:5173/)
...
- **[Smart-Housing-Finder](https://github.com/marat-kabirov/smart-housing-finder)** — Fullstack housing aggregation platform with AI cover letter generation
